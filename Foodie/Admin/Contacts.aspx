                                             ...
                                             <asp:Repeater ID="rContacts" runat="server" OnItemCommand="rContacts_ItemCommand">
                                                 ...
                                                 <itemtemplate>
                                                     <tr>
                                                         ...
                                                         <td>
                                                             <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CssClass="badge badge-danger" CommandArgument='<%# Eval("ContactId") %>' CommandName="delete" OnClientClick="return confirm('Do you want to delete this Record?');"><i class="ti-trash"></i></asp:LinkButton>
                                                         </td>
                                                     </tr>
                                                 </itemtemplate>
                                                 <footertemplate>
