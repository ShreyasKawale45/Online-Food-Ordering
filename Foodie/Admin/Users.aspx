                                                ...
                                                <asp:Repeater ID="rUsers" runat="server" OnItemCommand="rUsers_ItemCommand">
                                                    ...
                                                    <itemtemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CssClass="badge badge-danger" CommandArgument='<%# Eval("UserId") %>' CommandName="delete" OnClientClick="return confirm('Do you want to delete this User?');"><i class="ti-trash"></i></asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                    </itemtemplate>
                                                    <footertemplate>
