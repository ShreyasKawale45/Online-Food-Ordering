...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%
        string ImageUrl = Session["ImageUrl"] != null ? Session["ImageUrl"].ToString() : "../Images/img.jpg";
    %>
                            ...
                            <div class="card-title mb-4">
                                <div class="d-flex justify-content-lg-start">
                                    <div class="image-container">
                                        <img src="<%= Utils.GetImageUrl(ImageUrl).ToString() %>" id="imgProfile" style="width: 150px; height: 150px" class="img-thumbnail" />
                                        <div class="middle pt-2">
                                            <a href="Registration.aspx?id=<%Response.Write(Session["UserId"]);%>"
                                                class="btn btn-warning"><i class="fa fa-pencil"></i>Edit Details 
                                            </a>
                                        </div>
                                    </div>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3 col-md-2 col-5">
                                                            <lable style="font-weight: bold;">Full Name</lable>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3 col-md-2 col-5">
                                                            <lable style="font-weight: bold;">Mobile No.</lable>
                                                        </div>
                                                        <div class="col-md-8 col-6">
                                                            <%# Eval("Mobile") %>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3 col-md-2 col-5">
                                                            <lable style="font-weight: bold;">Email Address</lable>
                                                        </div>
                                                        <div class="col-md-8 col-6">
                                                            <%# Eval("Email") %>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3 col-md-2 col-5">
                                                            <lable style="font-weight: bold;">Post Code</lable>
                                                        </div>
                                                        <div class="col-md-8 col-6">
                                                            <%# Eval("PostCode") %>
                                                        </div>
