                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>₹<asp:Label ID="lblPrice" runat="server" Text='<%# Eval("Price") %>'></asp:Label>
                            ...
                            <asp:HiddenField ID="hdnPrdQuantity" runat="server" Value='<%# Eval("ProQty") %>' />
                        </td>
                        <td>
                            <div class="product__details__option">
                                <div class="quantity">
                                    <div class="pro-qty">
                                        <asp:TextBox ID="txtQuantity" runat="server"  Text='<%# Eval("Qty") %>'></asp:TextBox>
                        ...
                        <td>
                            <asp:LinkButton ID="lblDelete" runat="server" Text="Remove" CommandArgument='<%# Eval("ProductId") %>' OnClientClick="return confirm('Do you want to remove this item from cart?');" CommandName="remove"><i class="fa fa-close"></i></asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
