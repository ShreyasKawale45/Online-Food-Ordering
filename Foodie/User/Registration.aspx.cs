    ...
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (fuUserImage.HasFile)
            {
                ...
                fuUserImage.SaveAs(MapPath("~/Images/User/" + fuUserImage.FileName));
                imagePath = "Images/User/" + fuUserImage.FileName;
                cmd.Parameters.AddWithValue("@ImageUrl", imagePath);
                isValidToExecute = true;
            }
            else
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    con.Open();
                    cmd.ExecuteNonQuery();
                    actionName = userId == 0 ? " registration is successfull! <b><a href='Login.aspx'>Click here</a></b> to do login" : "details updated successfull! <b><a href='Profile.aspx'>Can check here</a></b>";
                    lblMsg.Visible = true;
        ...
        void getUserDetails()
        {
            ...
            if(dt.Rows.Count == 1)
            {
                ...
                imgUser.ImageUrl = string.IsNullOrEmpty(dt.Rows[0]["ImageUrl"].ToString())
                    ? "../Image/img.jpg " : " ../ " + dt.Rows[0]["ImageUrl"].ToString();
                imgUser.Height = 200;
                imgUser.Width = 200;
